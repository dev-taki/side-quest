...
const SQUARE_CONFIG = {
  applicationId: 'sandbox-sq0idb-x0UMzu6vZ3-7eM8oqiDnvw',
  locationId: 'L05SSGPBJR593',
};
...
export default function SquarePaymentForm({ planVariationId, onSuccess, onError }: SquarePaymentFormProps) {
  ...
  const initializeSquare = async () => {
    try {
      if (!window.Square || initializedRef.current) {
        return;
      }
